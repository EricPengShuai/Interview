//
// Created by pengshuai on 2022/5/4. refer to LightCity
//
...
// (2) 展开函数, 把参数分为一个普通参数和一个参数包，调用一次，参数包大小就减一
...
/* *
...Args 是可变参数：具体参考：https://blog.csdn.net/wodownload2/article/details/117512062
hash start
parameter asdas
parameter 2
parameter 3
